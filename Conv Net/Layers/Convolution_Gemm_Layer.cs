...
namespace Conv_Net {
    class Convolution_Gemm_Layer {
        ...
        public Convolution_Gemm_Layer(int I_channels, int F_num, int F_rows, int F_columns, bool needs_gradient, int pad_size = 0, int stride = 1, int dilation = 1) {
