...
namespace Conv_Net {
    class Net {
        ...
        public Base_Layer[] layer_list = {
            new Convolution_Layer(1, 16, 5, 5, false, 0, 1, 1, 1),
            new Batch_Normalization_Layer(16),
            new Relu_Layer(),
            new Max_Pooling_Layer(2, 2, 2),
            new Dropout_Layer(0.2),

            new Convolution_Layer(16, 32, 5, 5, true, 0, 1, 1, 1),
            new Batch_Normalization_Layer(32),
            new Relu_Layer(),
            new Max_Pooling_Layer(2, 2, 2),
            new Dropout_Layer(0.2),

            new Flatten_Layer(),
            new Fully_Connected_Layer(4 * 4 * 32, 10, true),
            new Softmax_Loss_Layer()
        };
        
        public Optimizer Optim = new Optimizer();
